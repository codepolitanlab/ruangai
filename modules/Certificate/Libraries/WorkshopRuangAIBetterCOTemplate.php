...
class WorkshopRuangAIBetterCOTemplate extends CertificateTemplate
{
    public function getName(): string
    {
        return 'workshop_ruangai_betterco';
    }
    ...
    {
        return 'Workshop RuangAI BetterCO';
    }
    ...
    public function getConfig(): array
    {
        return [
            ...
            'pages' => [
                // Halaman 1 - Indonesia
                $this->createPage(
                    base_url('certificates/tpl/template-ruangai-betterco-min.png'),
                    [
