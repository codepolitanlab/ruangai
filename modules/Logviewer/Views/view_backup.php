    ...
    <section class="section">
                ...
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <?php endif; ?>
                            <button type="button" class="btn btn-outline-info" onclick="toggleLineNumbers()">
        ...
        <div class="card card-block rounded-xl shadow">
            ...
            <div class="card-body p-0">
                ...
                <?php else: ?>
                    <div class="log-content" style="font-family: 'Courier New', monospace; font-size: 13px;">
                        <?php foreach ($content as $entry): ?>
                            <div class="log-entry border rounded mb-3 p-3" 
                                ...
                                <div class="raw-lines collapse mt-2" id="raw-<?= $entry['number'] ?>">
                                    ...
                                    <div class="bg-dark text-light rounded p-2" style="font-size: 11px;">
