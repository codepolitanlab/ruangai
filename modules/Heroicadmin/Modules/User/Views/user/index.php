    ...
    <div class="page-title mb-3">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first text-end">
                ...
                <a href="/<?= urlScope() ?>/user/form" class="btn btn-primary"><i class="bi bi-plus"></i> Tambah Pengguna</a>
            </div>
        </div>
    </div>
        ...
        <div class="card rounded-xl shadow">
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <a class="resetcache m-2 h5" href="/<?= urlScope() ?>/user/reset_cache"><span class="bi bi-arrow-repeat"></span></a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <form method="GET" action="/<?= urlScope() ?>/user">
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="/<?= urlScope() ?>/user" class="btn btn-secondary">Reset</a>
                                        </div>
                                    </td>
                                </tr>
                            </form>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group">
                                           ...
                                           href="/<?= urlScope() ?>/user/activate/<?= $user->id ?>"
                                           onclick="return confirm('Email belum tervalidasi. Lanjutkan aktivasi?')">
                                            ...
                                            <a class="btn btn-sm btn-outline-secondary text-nowrap"
                                                href="/<?= urlScope() ?>/user/form?id=<?= $user->id ?>">
                                                <span class="bi bi-pencil-square"></span> Edit
                                            </a>

                                            <form action="/<?= urlScope() ?>/user/delete" method="post" class="d-inline"
