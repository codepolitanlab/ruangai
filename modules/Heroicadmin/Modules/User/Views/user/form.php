...
<div class="page-heading">
    <section class="section">
        <form method="post" action="<?= isset($user) ? '/' . urlScope() . '/user/form?id=' . $user->id : '/' . urlScope() . '/user/form' ?>">
            <div class="mb-3">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <h2><a href="/<?= urlScope() ?>/user"><?= $page_title ?></a> • <?= isset($user) ? 'Edit' : 'New' ?></h2>
                    ...
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="mypassword" class="form-control" <?= isset($user) ? '' : 'required' ?> autocomplete="new-password">
                                <?php if(isset($user)): ?>
