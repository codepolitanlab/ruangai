...
<body>
    ...
    <div id="app">
        ...
        <?= $this->include('Heroicadmin\Views\_partials\sidebar') ?>

        <!-- Content Section -->
        <div id="main" class="layout-navbar navbar-fixed position-relative">
            <?= $this->include('Heroicadmin\Views\_partials\header') ?>

            <div id="main-content">
                <?= $this->include('Heroicadmin\Views\_partials\alerts') ?>

                <?= $this->renderSection('main') ?>
            </div>

            <?= $this->include('Heroicadmin\Views\_partials\footer') ?>
        </div>
