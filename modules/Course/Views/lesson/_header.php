<div class="mb-3">
    <div class="row">
        <div class="col">
            <h2 class="d-flex">
                <div>
                    <a href="<?= site_url(urlScope() . '/course') ?>"><i class="bi bi-house"></i></a>
                    &middot;
                    <?= $course['course_title'] ?>
                </div>
                ...
                <div class="ms-auto">
                    <a class="ms-2 btn btn-sm btn-outline-secondary"
                        ...
                        href="<?= site_url(urlScope() . '/course/edit/' . $course['id']) ?>">
                    ...
                    title="Add topic"
                    href="<?= site_url(urlScope() . '/course/lesson/topic/' . $course['id']) ?>">
