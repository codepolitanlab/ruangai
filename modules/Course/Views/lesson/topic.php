        ...
        <div class="card card-block block-editor p-3">
            <div class="row">
                ...
                <div class="col-md-9 px-4">
                    ...
                    <form action="<?= site_url(urlScope() . '/course/' . $course['id'] . '/topic/' . ($topic['id'] ?? '')) ?>" method="POST" class="p-2">
                        <div class="row mb-3">
                        ...
                        <div class="row mt-3 pt-3 border-top">
                            <div class="col-6">
                                <?php if ($topic ?? null): ?>
                                    <a href="<?= site_url(urlScope() . '/course/' . $course['id'] . '/topic/' . $topic['id'] . '/delete') ?>"
                            ...
                            <div class="col-6 text-end">
                                <a class="btn btn-secondary" href="<?= site_url(urlScope() . '/course/lesson/' . $course['id']) ?>">
