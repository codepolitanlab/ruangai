...
<div class="container">
    <a href="/<?= urlScope() ?>/course/live/<?= $batch['id'] ?>/meeting" class="btn btn-link"><i class="bi bi-arrow-left"></i> Kembali</a>
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="module_url" id="module_url" class="form-control" value="<?= $meeting['module_url'] ?? '' ?>">
                            </div>
                            <div class="mb-3">
