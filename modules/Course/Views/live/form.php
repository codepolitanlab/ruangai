...
<div class="container">
    <a href="/<?= urlScope() ?>/course/<?= $course['id'] ?>/live" class="btn btn-link"><i class="bi bi-arrow-left"></i> Kembali</a>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card rounded-xl shadow">
                    <div class="card-body">
                        <form action="<?= site_url(urlScope() . '/course/' . $course['id'] . '/' . (isset($batch) ? '/live/' . $batch['id'] . '/edit' : '/live/create')) ?>" method="post">
                            <div class="mb-3">
