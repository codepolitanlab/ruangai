...
class MeetingAttendance extends AdminController
{
    ...
    public function index($meeting_id = null)
    {
        ...
        $this->model->select('live_attendance.id, users.name, users.email, users.phone, live_attendance.duration, zoom_join_link, meeting_feedback_id, live_attendance.status, course_students.graduate, course_students.graduate_at, live_meeting_feedback.content as feedback_content');
