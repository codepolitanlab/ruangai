            ...
            <tr>
              <td style="padding:20px;font-family:sans-serif;color:#333;">
                <p style="margin-top:0;font-size:16px;line-height:1.5;">
                  ...
                  Kami menerima permintaan penggantian kata sandi untuk akun Anda di aplikasi <?= esc($aplikasi ?? '{APLIKASI}') ?>.<br>
                ...
                <p style="font-size:16px;line-height:1.5;">
                  <em>
                    ABAIKAN PESAN INI JIKA kamu merasa tidak melakukan permintaan pergantian kata sandi. JANGAN PERNAH membagikan kode reset kepada siapapun.
                  </em>
                </p>
