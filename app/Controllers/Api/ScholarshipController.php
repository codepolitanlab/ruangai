...
class ScholarshipController extends ResourceController
{
    ...
    public function userReferral()
    {
        ...
        $memberQuery = $participantModel->select('fullname, status, scholarship_participants.created_at as joined_at, course_students.graduate, course_student.progress, COUNT(live_attendance.id) as total_live_session')
