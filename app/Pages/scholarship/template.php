			...
			<div class="">
				...
				<template x-if="data.scholarships && data.scholarships.length > 0">
					<div class="bg-white px-3 py-4 rounded-4 mb-4 shadow-sm">
						...
						<template x-for="scholarship in data.scholarships" :key="scholarship.id">
							<div class="card shadow-sm overflow-hidden mb-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
								<div class="card-body p-4">
									<div class="d-flex justify-content-between align-items-start mb-3">
										<div>
											<h5 class="text-white fw-bold mb-1">Dasar dan Penggunaan Generative AI</h5>
											<span class="scholarship-badge bg-white bg-opacity-25">
												<i class="bi bi-trophy-fill me-1"></i>
												<span x-text="scholarship.program || 'Beasiswa Aktif'"></span>
											</span>
										</div>
									...
									<div class="row g-2 text-white mt-3">
										<div class="col-6">
											...
											<p class="mb-0 fw-bold text-capitalize" x-text="scholarship.status || 'Terdaftar'"></p>
										</div>
										<div class="col-6">
											<small class="opacity-75">Tanggal Daftar</small>
											<p class="mb-0 fw-bold" x-text="$heroicHelper.formatDate(scholarship.created_at)"></p>
										</div>
									</div>

									<div class="mt-3 pt-3 border-top border-white border-opacity-25">
										<a href="/courses/intro/1/dasar-dan-penggunaan-generative-ai" class="btn btn-light w-100 rounded-pill">
