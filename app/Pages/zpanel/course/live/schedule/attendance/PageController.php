...
class PageController extends AdminController
{
    ...
    public function getExport($meeting_id = null)
    {
        ...
        $liveAttendanceModel->select('live_meetings.meeting_code, live_meetings.title, users.name, users.email, live_attendance.duration, live_attendance.status, live_attendance.created_at');
