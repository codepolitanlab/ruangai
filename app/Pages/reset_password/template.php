<div id="member-reset-password" x-data="reset_password(`<?= config('Heroic')->recaptcha['siteKey'] ?>`)">
    ...
    <div class="appHeader bg-transparent">
        <div class="left">
    ...
    <!-- App Capsule -->
    <div id="appCapsule" class="pt-5 pb-2 px-4">
        <div class="card shadow rounded-4 py-4 px-2">
            <div class="mt-1">
                ...
                <div class="login-form mt-5 mx-auto pt-1 px-2 rounded glassmorph" style="background: #fffa">
                    ...
                    <div>
                        ...
                        <div class="form-group px-3">
                            <button type="button" x-on:click="confirm" class="btn btn-primary btn-block btn-lg rounded-5" :disabled="sending || (model.phone.length < 10 && model.email.length < 10)">
