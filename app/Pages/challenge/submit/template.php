<div
    ...
    <style>
        ...
        .accordion .accordion-header .btn, .accordion .accordion-header .accordion-button:focus {
            background: #0f957c !important;
            border-radius: 1rem !important;
            color: white;
        }
        .accordion .accordion-header .btn, .accordion .accordion-header .accordion-button:after {
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-3">
            ...
            <?= $this->include('challenge/submit/_teams'); ?>
