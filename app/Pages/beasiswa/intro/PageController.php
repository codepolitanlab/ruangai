...
namespace App\Pages\beasiswa\intro;
...
class PageController extends BaseController
{
    ...
    public function getData()
    {
        ...
        if ($course) {
            ...
            $isUnlimitedAccess = in_array($this->data['student']['occupation'] ?? '', ['freelance', 'fresh_graduate', 'jobseeker']) && empty($this->data['student']['expire_at']);
            ...
            if ($isRAICollaboration || $isUnlimitedAccess) {
