...
namespace App\Pages\beasiswa\intro\live_session;
...
class PageController extends BaseController
{
    ...
    public function getData()
    {
        ...
        $attended = $db->table('live_attendance')
            ...
            live_attendance.status, live_attendance.zoom_join_link, live_meetings.recording_link, ADDTIME(meeting_time, SEC_TO_TIME(meeting_duration * 60)) AS meeting_end')
