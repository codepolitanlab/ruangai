<div
	...
	x-data="$heroic({
        title: `<?= $page_title ?>`,
		url: `beasiswa/intro/student/data/${$params.course_id}`
    })">
	...
	<div id="appCapsule" class="">
		<div class="appContent" style="min-height:90vh">
			...
			<?= $this->include('beasiswa/intro/_header'); ?>
						...
						<div class="card shadow-none border rounded-20 p-2 mb-2">
							<div class="d-flex gap-3 align-items-center">
								...
								<div class="flex-grow-1">
									...
									<h5 class="mb-2">
										<a :href="`/beasiswa/intro/${$params.course_id}/${$params.slug}/student/${student.user_id}`" x-text="student.name"></a>
									</h5>
