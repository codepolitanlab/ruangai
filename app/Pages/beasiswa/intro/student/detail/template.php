<div id="student_detail"
	x-data="$heroic({
        title: `<?= $page_title ?>`,
		url: `beasiswa/intro/student/detail/data/${$params.id}`
    })"
	>
	<div id="app-header" class="appHeader main border-0">
		<div class="left"><a class="headerButton" :href="`/beasiswa/intro/${$params.course_id}/${$params.slug}/student`"><i class="bi bi-chevron-left"></i></a></div>
