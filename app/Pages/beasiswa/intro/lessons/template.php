<div
	...
	x-data="$heroic({
        title: `<?= $page_title ?>`,
        url: `/beasiswa/intro/lessons/data/${$params.course_id}`
    })"
	x-effect="loadPage(`/beasiswa/intro/lessons/data/${$params.course_id}`)">
...
<?= $this->include('beasiswa/intro/lessons/script') ?>