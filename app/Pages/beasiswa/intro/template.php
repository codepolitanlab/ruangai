<div
	...
	<style>
		...
		/* Kartu elevated (klaim sertifikat / kelas lanjutan) sedikit lebih terang */
		...
		/* Kotak peringatan kuning: teks tetap gelap agar terbaca */
		#course_intro .bg-warning .text-dark {
