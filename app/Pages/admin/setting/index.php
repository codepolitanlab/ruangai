...
<div class="page-heading">
    ...
    <section class="section">
        <form action="/ruangpanel/setting/update/site" method="post">
            ...
            <div class="dropright me-3 d-block d-md-none">
                ...
                <div class="dropdown-menu shadow-lg" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item py-1 active" href="/ruangpanel/setting/index/site">Site</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/theme">Theme</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/emailer">Emailer</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/app">App Setting</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/plugin">Plugins</a>
                    <div class="dropdown-divider"></div>


                    <strong class="font-weight-bold dropdown-item">Module Settings</strong>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/activity" role="tab" aria-controls="v-pills-activity" aria-selected="false">Activity</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/entry" role="tab" aria-controls="v-pills-entry" aria-selected="false">Entries</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/media" role="tab" aria-controls="v-pills-media" aria-selected="false">File Manager</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/post" role="tab" aria-controls="v-pills-post" aria-selected="false">Posts</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/microblog" role="tab" aria-controls="v-pills-microblog" aria-selected="false">Microblog</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/user" role="tab" aria-controls="v-pills-user" aria-selected="false">Users</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/search" role="tab" aria-controls="v-pills-search" aria-selected="false">Search</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/notifier" role="tab" aria-controls="v-pills-notifier" aria-selected="false">Notifier</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/donation" role="tab" aria-controls="v-pills-donation" aria-selected="false">Campaign</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/membership" role="tab" aria-controls="v-pills-membership" aria-selected="false">Membership</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/payment" role="tab" aria-controls="v-pills-payment" aria-selected="false">Payment</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/product" role="tab" aria-controls="v-pills-product" aria-selected="false">Products</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/referral" role="tab" aria-controls="v-pills-referral" aria-selected="false">Referral</a>
                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/course" role="tab" aria-controls="v-pills-course" aria-selected="false">Courses</a>

                    <a class="dropdown-item py-1 " href="/ruangpanel/setting/index/downloadable" role="tab" aria-controls="v-pills-downloadable" aria-selected="false">Downloadable</a>
                ...
                <div class="nav col-lg-3 col-md-3 col-5 flex-column nav-pills mb-5 ps-2 d-none d-md-flex" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <div class="card rounded-xl shadow">
                        <div class="card-body">
                            ...
                            <a class="nav-link active" href="/ruangpanel/setting/index/site">Site</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/theme">Theme</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/emailer">Emailer</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/app">App Setting</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/plugin">Plugins</a>


                            <h6 class="font-weight-bold text-info p-2 mb-0 mt-2 border-top border-bottom">Module Settings</h6>
                            <a class="nav-link " href="/ruangpanel/setting/index/activity" role="tab" aria-controls="v-pills-activity" aria-selected="false">Activity</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/entry" role="tab" aria-controls="v-pills-entry" aria-selected="false">Entries</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/media" role="tab" aria-controls="v-pills-media" aria-selected="false">File Manager</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/post" role="tab" aria-controls="v-pills-post" aria-selected="false">Posts</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/microblog" role="tab" aria-controls="v-pills-microblog" aria-selected="false">Microblog</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/user" role="tab" aria-controls="v-pills-user" aria-selected="false">Users</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/search" role="tab" aria-controls="v-pills-search" aria-selected="false">Search</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/notifier" role="tab" aria-controls="v-pills-notifier" aria-selected="false">Notifier</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/donation" role="tab" aria-controls="v-pills-donation" aria-selected="false">Campaign</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/membership" role="tab" aria-controls="v-pills-membership" aria-selected="false">Membership</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/payment" role="tab" aria-controls="v-pills-payment" aria-selected="false">Payment</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/product" role="tab" aria-controls="v-pills-product" aria-selected="false">Products</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/referral" role="tab" aria-controls="v-pills-referral" aria-selected="false">Referral</a>
                            <a class="nav-link " href="/ruangpanel/setting/index/course" role="tab" aria-controls="v-pills-course" aria-selected="false">Courses</a>

                            <a class="nav-link " href="/ruangpanel/setting/index/downloadable" role="tab" aria-controls="v-pills-downloadable" aria-selected="false">Downloadable</a>
