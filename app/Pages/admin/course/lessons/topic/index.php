            ...
            <div class="row">
                <div class="col-md-3 border-right">
                    <div class="toolbar-lesson d-flex justify-content-between mb-2">
                        ...
                        <a href="/ruangpanel/course/manage_lessons/1/add_topic" class="btn btn-sm btn-secondary"><span class="bi bi-tag"></span> Add Topic</a>
                    </div>
                ...
                <div class="col-md-9">
                    ...
                    <form action="/ruangpanel/course/save_topic/1/" method="POST" class="p-2">
                        <div class="row mb-3">
                        ...
                        <div class="row mt-3 pt-3 border-top">
                            ...
                            <div class="col-6 text-end">
                                <a class="btn btn-secondary" href="/ruangpanel/course/manage_lessons/1"><span class="fa fa-arrow-left"></span> Cancel</a>
