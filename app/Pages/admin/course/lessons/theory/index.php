        ...
        <div class="card card-block block-editor p-3">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <form action="/ruangpanel/course/save_theory/1/1/" method="post">
                        ...
                        <div class="row mt-3 pt-2">
                            <div class="col-6">
                                <a class="text-danger" onclick="return confirm('Anda yakin akan menghapus lesson ini?')" href="/ruangpanel/course/delete_lesson/1/1/"><span class="fa fa-trash"></span> Hapus Lesson</a>
                            </div>
                    ...
                    <script>
                        $(function() {
                            ...
                            $('#btnGetDuration').on('click', function() {
                                ...
                                $.get("/ruangpanel/course/getYoutubeDuration/" + vidKey + "/1", function(data) {
