            ...
            <div class="row">
                <div class="col-md-3 border-right">
                    <div class="toolbar-lesson d-flex justify-content-between mb-2">
                        ...
                        <a href="/ruangpanel/course/lessons/topic" class="btn btn-sm btn-outline-white"><span class="bi bi-tag"></span> Add Topic</a>
                    </div>
                    ...
                    <div class="sidebar-lesson" style="margin: 0 -15px; padding: 15px;">
                        <ul class="lesson-list list-unstyled">
                            <li class="p-2 mb-3 border shadow-sm">
                                ...
                                <div class="mb-2">
                                    <a class="btn btn-sm btn-link badge bg-info" href="/ruangpanel/course/lessons/theory" title="Buat materi baru"><span class="bi bi-plus-circle"></span> Add Lesson</a>
                                    <a class="btn btn-sm btn-link badge bg-info" href="/ruangpanel/course/lessons/quiz" title="Buat quiz baru"><span class="bi bi-plus-circle"></span> Add Quiz</a>
                                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="text-center mt-5">
                        ...
                        <a href="/ruangpanel/course/lessons/topic" class="btn btn-primary"><span class="bi bi-plus-circle"></span> Create Topic</a>
                        <!-- 	<a href="/ruangpanel/course/lessons/theory" class="btn btn-primary"><span class="bi bi-plus-circle"></span> Create Lesson Theory</a>
	<a href="/ruangpanel/course/lessons/quiz" class="btn btn-primary"><span class="bi bi-plus-circle"></span> Create Lesson Quiz</a> -->
                    </div>
                </div>
            </div>
        </div>
