<div
    ...
    <div id="app-header" class="appHeader main border-0 d-lg-none" style="background: white; border-bottom: 1px solid #e9ecef;">
        <div class="left">
            <a class="headerButton" :href="`/courses/intro/${$params.course_id}/${$params.slug}/live_session`">
        ...
        <template x-if="data?.response_code && data.response_code !== 200">
            <div class="alert-overlay">
                <div class="alert-box">
                    ...
                    <a :href="`/courses/intro/${$params.course_id}/${$params.slug}/live_session`" class="btn btn-primary">Kembali</a>
                </div>
            </div>
        </template>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="d-none d-lg-block mb-3">
                            <a :href="`/courses/intro/${$params.course_id}/${$params.slug}/live_session`" class="btn btn-light">
