        ...
        <div class="appContent" style="min-height:90vh;">
            ...
            <section>
                ...
                <section>
                    <a href="/courses/tanya_jawab">
                        <div class="p-2 d-flex gap-2">
                            <i class="bi bi-arrow-left h4 text-white"></i>
                            <h5>Kembali</h5>
                        </div>
                    </a>
                </section>
                ...
                <section class="container py-4 pt-0">
                    ...
                    <h4 class="text-white mb-2 mt-5">1 Jawaban</h4>

                    <div class="card bg-grey rounded-20 p-3 mb-2" style="border: 4px solid rgba(0, 0, 0, 0.9);">
                        <div class="d-flex justify-content-between border-3 border-bottom border-black pb-2">
                            <div class="d-flex gap-3 align-items-center">
                                <img src="https://cdn-icons-png.flaticon.com/512/8792/8792047.png" class="rounded-circle" style="width: 50px;height: 50px" alt="">
                                <div>
                                    <h5 class="m-0 mb-1">Badar Abdi Mulya</h5>
                        ...
                        <div class="card-footer pb-0 px-1 d-flex justify-content-between border-3 border-black text-white">
                            <div>38 Menit yang lalu</div>
                            <div>Lihat Komentar (<span class="text-pink">0</span>)</div>
                        </div>
                    </div>
                </section>
            </section>
