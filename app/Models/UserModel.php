...
class UserModel extends Model
{
    ...
    protected $allowedFields = ['name', 'username', 'email', 'avatar', 'role_id', 'source', 'pwd', 'phone', 'token', 'last_active', 'phone_valid', 'email_valid', 'created_at', 'updated_at', 'deleted_at'];
